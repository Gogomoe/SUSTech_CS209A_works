...
public class FitPlot extends Application {
    ...
    public void start(Stage stage) {
        ...
        XYChart.Series<Number, Number> sim = new XYChart.Series<>();
        ...
        XYChart.Series<Number, Number> simUp = new XYChart.Series<>();
        ...
        XYChart.Series<Number, Number> simDn = new XYChart.Series<>();
